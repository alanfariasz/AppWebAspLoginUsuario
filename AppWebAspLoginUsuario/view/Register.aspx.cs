...
namespace AppWebAspLoginUsuario
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "Data Source=36DE250006\\SENAC;Initial Catalog=login;Integrated Security=True";
            /* Abertura da Conexão */
            con.Open();
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "INSERT INTO users(email, pass, nome, telefone)VALUES('" + txbEmail.Text.ToString() + "', '" + txbPass.Text.ToString() + "', '" + txbNome.Text.ToString() + "', '" + txbTelefone.Text.ToString() + "')";
